import type { CommentReactionType, CommentReactionUser } from '@/features/comment/types/contracts';
import type { CommentReactionUserResponseDto } from '@/features/comment/api/dtos/response.dto';
...
export const mapReactionUser = (payload: CommentReactionUserResponseDto): CommentReactionUser | null => {
