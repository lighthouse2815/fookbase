...
export const AuthLayout = ({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white max-md:min-h-[100svh]">
      <AuthBackground tone={tone} compact={isMobileViewport} />
      <div className="absolute inset-0 z-[3]">
        <CherryBlossomFall />
      </div>

      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1280px] flex-col px-4 pb-7 pt-6 max-md:min-h-[100svh] max-md:justify-center sm:px-6 sm:pb-10 sm:pt-8 lg:flex-row lg:items-center lg:gap-14 lg:px-10 lg:py-10">
        <motion.section
          layout
          layoutId="auth-hero-panel"
          variants={shouldReduceMotion ? undefined : AUTH_HERO_STAGGER_VARIANTS}
          initial={shouldReduceMotion ? false : 'hidden'}
          animate={shouldReduceMotion ? undefined : 'visible'}
          className="mb-6 hidden w-full md:block lg:mb-0 lg:w-[46%]"
        >
          <motion.span
            variants={shouldReduceMotion ? undefined : AUTH_HERO_LINE_VARIANTS}
          ...
          <motion.div variants={shouldReduceMotion ? undefined : AUTH_HERO_LINE_VARIANTS}>
        ...
        <motion.section
          ...
          variants={shouldReduceMotion ? undefined : AUTH_FORM_SHELL_VARIANTS}
          initial={shouldReduceMotion ? false : 'hidden'}
          animate={shouldReduceMotion ? undefined : 'visible'}
          className="w-full max-md:mx-auto max-md:max-w-[560px] lg:w-[54%]"
        >
          {children}
        </motion.section>
      </div>
