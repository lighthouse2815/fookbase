...
import type { GameOverEvent, GameStateUpdatedEvent, GameStartedEvent, MoveRejectedEvent } from '@/features/games/types/common';
import type { ChessMoveInput, ChessState } from '@/features/games/types/chess';
