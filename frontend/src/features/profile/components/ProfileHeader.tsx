...
import type { ProfileHeaderProps } from '@/features/profile/types/components';
import { useProfileHeader } from '@/features/profile/hooks/useProfileHeader';

export type { ProfileHeaderProps } from '@/features/profile/types/components';
