...
import { useAdminUserReportsPage } from '@/features/admin/hooks/useAdminUserReportsPage';
                ...
                <div className="rounded-xl border border-slate-200 p-3 dark:border-slate-700">
                  ...
                  {report.targetUser ? (
                    <Link to={`/profile/${report.targetUser.id}`} className="mt-2 flex items-center gap-2">
                      <img
                        src={report.targetUser.avatarUrl || DEFAULT_ADMIN_AVATAR_URL}
