...
export const DEFAULT_ADMIN_AVATAR_URL = 'https://res.cloudinary.com/drfhezlyn/image/upload/v1776615564/default_avatar_art0sv.jpg';
...
export const normalizeAdminUser = (item: AdminUserItem): AdminUserItem => ({
  ...
  avatarUrl: item.avatarUrl || DEFAULT_ADMIN_AVATAR_URL,
});

export const getAdminUserStatusBadgeClass = (status: string): string => {
...
export const getAdminRoleBadgeClass = (role: string): string => {
