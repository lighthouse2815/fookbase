...
import com.dangngulon.frontend.feature.zola.presentation.viewmodel.GroupsViewModel;
...
public class GroupsFragment extends Fragment {
    ...
    private void setupClickListeners() {
        ...
        binding.createGroupAction.setOnClickListener(v -> navController.navigate(R.id.action_global_createGroup));
    }
    ...
    private void navigateToChatScreen(ConversationUiModel conversation) {
        ...
        navController.navigate(R.id.action_global_chatDetailFragment, args);
    }

    private void observeViewModel() {
        groupsViewModel.getGroupsListResult().observe(getViewLifecycleOwner(), result -> {
            if (result == null) {
                return;
            }
