...
import com.dangngulon.frontend.viewmodel.zola.MessagesViewModel;
...
public class MessagesFragment extends Fragment {
    ...
    private void setupRecyclerView() {
        ...
        adapter.setOnConversationClickListener(new ConversationAdapter.OnConversationClickListener() {
            ...
            public void onConversationLongClick(ConversationResponse conversation) {
                Toast.makeText(getContext(), "Tùy chọn: " + conversation.getName(), Toast.LENGTH_SHORT).show();
    ...
    private void navigateToChatScreen(ConversationResponse conversation) {
        ...
        navController.navigate(
            R.id.action_messagesFragment_to_chatDetailFragment,
            args
        );
    }

    private void observeViewModel() {
        messagesViewModel.getConversationListResult()
