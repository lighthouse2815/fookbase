...
public class UserProfileFragment extends Fragment {
    ...
    private void setupFragmentResultListeners() {
        getChildFragmentManager().setFragmentResultListener(
            ...
            (requestKey, result) -> {
                ...
                if (newNickname != null && binding != null) {
                    nickname = newNickname;
                    binding.tvNickname.setText(getString(R.string.nickname_display_format, nickname));
    ...
    private void updateUIForProfileType() {
        if (ProfileType.MY.name().equals(profileType)) {
            setupOwnProfile();
            return;
        }

        if (ProfileType.FRIEND.name().equals(profileType)) {
            setupFriendProfile();
            return;
        }
