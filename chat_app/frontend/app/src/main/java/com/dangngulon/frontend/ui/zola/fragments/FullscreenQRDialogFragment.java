...
import com.dangngulon.frontend.viewmodel.zola.FullscreenQRViewModel;
...
public class FullscreenQRDialogFragment extends DialogFragment {
    ...
    private void observeViewModel() {
        fullscreenQRViewModel.getSaveResult().observe(getViewLifecycleOwner(), event -> {
            ...
            if (success) {
                UiHelper.showToast(requireContext(), "Đã lưu mã QR vào thư viện");
            } else {
                UiHelper.showToast(requireContext(), "Lưu QR thất bại");
            }
        });
    }
