...
namespace fookbase.API.Migrations
{
    ...
    [Migration("20260513182608_AddPostVisibilityScope")]
    partial class AddPostVisibilityScope
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InteractHub.Api.Domain.Entities.FriendshipReadModel", b =>
                {
                    ...
                    b.HasKey("OwnerUserId", "OtherUserId");
                    ...
                    b.ToTable("FriendshipReadModel", (string)null);
                });

            modelBuilder.Entity("InteractHub.Api.Domain.Entities.FriendshipReadModelSyncState", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InteractHub.Api.Domain.Entities.Post", b =>
                {
                    b.HasOne("InteractHub.Api.Domain.Entities.Post", "OriginalPost")
