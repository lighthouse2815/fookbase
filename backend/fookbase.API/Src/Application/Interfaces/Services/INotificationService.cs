...
public interface INotificationService
{
    ...
    Task<NotificationResponseDto> GetByIdAsync(Guid notificationId, Guid userId, bool isAdmin, CancellationToken cancellationToken);

    Task<NotificationResponseDto> CreateAsync(CreateNotificationRequestDto request, CancellationToken cancellationToken);

    Task<NotificationResponseDto> MarkAsReadAsync(Guid notificationId, Guid userId, bool isAdmin, CancellationToken cancellationToken);

    Task MarkAllAsReadAsync(Guid userId, CancellationToken cancellationToken);

    Task DeleteAsync(Guid notificationId, Guid userId, bool isAdmin, CancellationToken cancellationToken);
}